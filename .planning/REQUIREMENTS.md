...
### Hardware Validation Spike (Phase 0)
...
### Pre-flight & Connection Test (Phase 1)
...
### UniFi Protect Adoption & Monitoring (Phase 3)
...
### Adaptive Stream Mode — Differentiator (Phase 4)

- [ ] **BAMBU-18**: MQTT subscription to `device/<serial>/report` detects active print state (user-configurable field — verified in Phase 0)
...
### Documentation & Installer (Phase 5)
...
*To be populated by the roadmapper — maps REQ-IDs to phases.*
