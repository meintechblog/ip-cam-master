...
- [x] 22-03-PLAN.md — Wave 3 (parallel): /kameras partition + ExternalCamCard + OutputsSubsection + OutputToggle + ProtectHubGuide + CameraDetailCard source gate (HUB-UI-01..06)
- [x] 22-04-PLAN.md — Wave 3 (parallel): Wizard Steps 3-6 + WizardStepIndicator + WizardResumeBanner + onboarding +page refactor (HUB-WIZ-05..10)
- [x] 22-05-PLAN.md — Wave 3 (parallel): HubStatusPanel + HubEventLog + ProtectHubTab integration + /settings/protect-hub/all-urls + /kameras toast banner (HUB-UI-07, HUB-UI-08)
...
| 22. Onboarding Wizard + `/cameras` Integration | 5/6 | In Progress|  |
